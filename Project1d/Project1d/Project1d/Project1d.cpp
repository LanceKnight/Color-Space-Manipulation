...
double* RGB2xyY(int r, int g, int b){
	...
	//cout << "Z= " << Z << "\n";
	//XYZ to Luv
	double x = (double)X / (double)((double)X + (double)Y + (double)Z);
	double y = (double)Y / (double)((double)X + (double)Y + (double)Z);
	//double Xw = 0.95;
	//double Yw = 1;
	//double Zw = 1.09;
...
int* xyY2RGB(double x, double y, double Y){
	//double Xw = 0.95;
	//double Yw = 1;
	//double Zw = 1.09;
	...
	double X = (double)x*(double)Y / (double)(y+0.001);
	
	double Z = (double)(1 - x - y)*(double)Y / (double)(y+0.001);
	...
	if (linear_g < 0.00304){
		...
		nonlinear_g = 1.055*(pow(linear_g, ((double)1 / (double)2.4))) - 0.055;
	}
	...
	if (linear_b < 0.00304){
		...
		nonlinear_b = 1.055*(pow(linear_b, ((double)1 / (double)2.4))) - 0.055;
	}
